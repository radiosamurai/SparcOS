...
local soundDir = "/opt/SparcOS-sounds/" -- The directory that has the sound files
      ...
      grabber =
        awful.keygrabber.run(
          function(_, key, event)
            ...
            elseif key == "c" then awful.spawn.with_shell("SparcOS-colorscheme")
...
--awful.spawn.with_shell("feh --randomize --bg-fill /usr/share/backgrounds/SparcOS-backgrounds/*") -- feh sets random wallpaper
