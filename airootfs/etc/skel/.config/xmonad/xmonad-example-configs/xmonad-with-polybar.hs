...
myStartupHook = do
  ...
  -- spawnOnce "feh --randomize --bg-fill /usr/share/backgrounds/SparcOS-backgrounds/*"  -- feh set random wallpaper
...
soundDir = "/opt/SparcOS-sounds/" -- The directory that has the sound files
...
myKeys c =
  ...
  , ("M-/", addName "SparcOS Help"                $ spawn "~/.local/bin/SparcOS-help")]
  ...
  , ("M-p c", addName "Choose color scheme"    $ spawn "~/.local/bin/SparcOS-colorscheme")
